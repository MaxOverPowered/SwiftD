...
import logoCar from "../company_Icon/new/truck_element.png";
                ...
                <div className="max-w-5xl mx-auto px-2 sm:px-6 lg:px-8">
                    <div className="relative flex justify-between h-13">
                        ...
                        <div className=" flex items-center h-12  sm:items-stretch sm:justify-left">
                            <div className="flex items-center item-left sm:h-15 ml-12 -mt-5 ">
                                ...
                                <Link to="/">
                                    <motion.img src={logo} alt="swift_Dispatch"
                    ...
                    {isOpen && (
                        <div className="flex lg:hidden relative " id="mobile-menu">
                            <div
                                className="px-2 pt-2 pb-3  space-y-1 absolute z-10 px-2 pt-2 pb-3 space-y-1 bg-white border-4 border-green-900 shadow-lg">
                                <Link
                                    to="/about"
