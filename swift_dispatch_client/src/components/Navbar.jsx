...
function Navbar({handleLanguageSwitch, language}) {
    ...
    const handleLanguageSwitchWithCookies = () => {
        const userAcceptedCookies = document.cookie.includes("userAcceptedCookies=true");
                ...
                <div className="max-w-5xl mx-auto px-2 sm:px-6 lg:px-8">
                    <div className="relative flex justify-between h-13">
                        ...
                        <div className="flex items-center h-12 sm:items-stretch sm:justify-left">
                            ...
                            <div className="hidden lg:block items-center justify-between w-full mt-3">
                                ...
                                <button onClick={handleLanguageSwitchWithCookies}
                    ...
                    {isOpen && (
                        <div className="flex lg:hidden relative" id="mobile-menu">
                            <div
                                className="absolute z-10 px-2 pt-2 pb-3 space-y-1 bg-white shadow-lg rounded-2xl mt-0.5">
                                <Link
                                    to="/about"
