...
const Footer = () => {
    ...
    return (
        <footer className="bg-gray-900 w-full">
            <div className="mt-5 max-w-xl mx-auto py-2 flex flex-col justify-between items-center">
                ...
                <div className="text-white mb-3 font-sans font-semibold mt-3">
                    ...
                    <p className="text-xs text-center">v1.0.1</p>
                </div>
                <div><p className="text-xs text-right  bottom-0 left-0">v1.0.1</p></div>
            </div>
        </footer>
);
};
