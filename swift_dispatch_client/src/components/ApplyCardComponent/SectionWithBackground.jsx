...
const SectionWithBackground = () => {
    ...
    return (
        <section className="relative flex items-center justify-center border-8 pt-16 lg:pt-24">
            <div
            ...
            {!showContactForm ? (
                <>
                    <div className="z-10 text-center mt-40 lg:mt-52 xl:mt-60">
                        ...
                        >
                            We can help you find amazing loads and good routes, fully coordinating the carrier’s
                            movement from point A to point B.<br/> Let’s get along and make money together!
                        </motion.p>
                        <p>
                            <motion.button
                        ...
                        <img src={text_element} className="mx-auto h-40 sm:h-48 lg:h-56 xl:h-64"/>
                    </div>
                </>
            ) : (
