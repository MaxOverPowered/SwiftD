        ...
        <div className="flex flex-wrap justify-center items-center">
          ...
          <div className="w-full sm:w-1/2 md:w-2/3 lg:w-3/4 md:pl-12">
            ...
            <p className="text-gray-700 leading-relaxed mb-6">
              ...
              a team of passionate car-hauling experts who love making our
              clients smile. With over 2 years of experience in the industry, we
              know America like the back of our hand, and we pride ourselves on
              our ability to efficiently and effectively dispatch our drivers to
            ...
            <div className="flex items-center mb-4">
              ...
              <p className="text-gray-700">
                Experienced drivers and top-of-the-line equipment to make your
                car-hauling experience a breeze 🚚
              </p>
            </div>
          </div>
        </div>
